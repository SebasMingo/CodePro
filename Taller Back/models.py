...
class Usuarios(db.Model): #db.Model indica que Usuarios 
    #es un modelo de datos gestionando por SQLAlchemy
    ...
    # Los atributos de instancia contienen los datos especificos que esos campos
    #almacenan
